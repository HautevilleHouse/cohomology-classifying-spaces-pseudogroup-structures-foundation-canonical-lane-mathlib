...
import HautevilleHouse.CohomologyClassifyingSpacesPseudogroupStructuresFoundationCanonicalLaneLean.GateLemmas

/-!
# Final Theorem

Constrained theorem closure for pseudogroup classifying space cohomology.
-/
